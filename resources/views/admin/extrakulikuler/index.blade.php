                                        ...
                                        <div class="flex gap-2">
                                            ...
                                            <a href="{{ route('admin.extrakulikuler.edit', $ex->id) }}"
                                                class="flex items-center justify-center transition-all duration-200 ease-linear rounded-md size-8 remove-item-btn bg-slate-100 text-slate-500 hover:text-custom-500 hover:bg-custom-100 dark:bg-zink-600 dark:text-zink-200 dark:hover:bg-custom-500/20 dark:hover:text-custom-500"><i
                                                    data-lucide="pencil" class="size-4"></i>
                                            </a>

                                            <!-- Button Delete (Trash) - Hover Merah -->
                                            ...
                                            <div
                                                ...
                                                <div class="mt-5 text-center">
                                                    ...
                                                    <p class="mt-2 text-sm font-medium">
                                                        Current Status:
                                                        <span
                                                            class="px-2 py-1 rounded {{ $ex->approve == 'approve' ? 'bg-green-100 text-green-600' : 'bg-yellow-100 text-yellow-600' }}">
                                                            {{ ucfirst($ex->approve) }}
                                                        </span>
                                                    </p>
                                                    <div class="flex justify-center gap-2 mt-6">
                                                        <form action="{{ route('admin.extrakulikuler.approve', $ex->id) }}"
                                                            method="POST">
                                                            @csrf

                                                            <!-- Input hidden untuk mengirim status baru -->
                                                            <input type="hidden" name="approve"
                                                                value="{{ $ex->approve == 'waiting' ? 'approve' : 'waiting' }}">

                                                            <button type="button"
                                                                data-modal-close="editStatusEkskulModal{{ $ex->id }}"
                                                ...
                                                <div class="mt-5 text-center">
                                                    ...
                                                    <div class="flex justify-center gap-2 mt-6">
                                                        <form class="delete-form"
                                                            action="{{ route('admin.extrakulikuler.destroy', $ex->id) }}"
                                                            method="post">
                                                            @method('DELETE')
                                                            @csrf
                                                            <button type="reset"
                                                                data-modal-close="deleteModal{{ $ex->id }}"
