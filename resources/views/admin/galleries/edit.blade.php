        ...
        <form action="{{ route('admin.galleries.update', $item->id) }}" method="post">
            ...
            <div class="grid grid-cols-1 gap-4">
                ...
                <div>
                    ...
                    @if ($item->embed_url)
                        <div style="aspect-ratio:16/9;">
                            <iframe src="{{ $item->embed_url }}" frameborder="0" allowfullscreen
                ...
                <div>
                    ...
                    <input type="text" name="embed_url" value="{{ old('embed_url', $item->embed_url) }}"
                        placeholder="https://..." class="form-input" required>
                    <p class="text-sm text-slate-400">Provide the social post URL. Caption will be taken from the embedded
                        post.</p>
                </div>
                <div>
