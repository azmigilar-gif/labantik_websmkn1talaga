        ...
        <form action="{{ route('admin.galleries.store') }}" method="post">
            ...
            <div class="grid grid-cols-1 gap-4">
                ...
                <div>
                    ...
                    <input type="text" name="embed_url" value="{{ old('embed_url') }}" placeholder="https://..." class="form-input" required>
                    <p class="text-sm text-slate-400">Provide the social post URL (Instagram/YT/TikTok/X). Caption will be taken from the embedded post.</p>
                </div>
                <div>
