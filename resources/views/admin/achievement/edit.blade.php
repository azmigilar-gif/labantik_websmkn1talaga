    ...
    <div
        ...
        <div class="container mx-auto p-6">
            <div class="mx-auto max-w-4xl rounded bg-white p-6 shadow-sm">
                <h2 class="mb-6 text-2xl font-semibold text-slate-800">Edit Prestasi</h2>
                @if ($errors->any())
                ...
                <form action="{{ route('admin.achievement.update', $a->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="grid grid-cols-12 gap-6">
                        ...
                        <div class="col-span-12 md:col-span-4">
                            ...
                            <select name="category" 
                                ...
                                <option value="Akademik" {{ old('category', $a->category) == 'Akademik' ? 'selected' : '' }}>Akademik</option>
                                <option value="Non-Akademik" {{ old('category', $a->category) == 'Non-Akademik' ? 'selected' : '' }}>Non-Akademik</option>
                                <option value="Olahraga" {{ old('category', $a->category) == 'Olahraga' ? 'selected' : '' }}>Olahraga</option>
                                <option value="Seni" {{ old('category', $a->category) == 'Seni' ? 'selected' : '' }}>Seni</option>
                            </select>
                        </div>
                        ...
                        <div class="col-span-12 md:col-span-6">
                            ...
                            <input type="text" name="winner_name" value="{{ old('winner_name', $a->winner_name) }}"
                                class="form-input w-full border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                        ...
                        <div class="col-span-12 md:col-span-6">
                            ...
                            <input type="text" name="winner_social" value="{{ old('winner_social', $a->winner_social) }}"
                                class="form-input w-full border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                        ...
                        <div class="col-span-12 md:col-span-6">
                            ...
                            <input type="date" name="date" value="{{ old('date', $a->date) }}"
                        ...
                        <div class="col-span-12 mb-6">
                            ...
                            <textarea id="editor" name="description" class="block w-full p-4 min-h-[200px] border border-slate-200 rounded"
                                placeholder="Deskripsi singkat" style="display:none;">{{ old('description', $a->description) }}</textarea>
                        ...
                        <div class="col-span-12 text-right mt-8 pt-4 pb-12" style="clear: both;">
                            <button type="submit"
                                class="btn bg-custom-500 border-custom-500 hover:bg-custom-600 hover:border-custom-600 focus:bg-custom-600 focus:border-custom-600 focus:ring-custom-100 active:bg-custom-600 active:border-custom-600 active:ring-custom-100 text-white font-semibold px-5 py-2.5 rounded">Perbarui</button>
