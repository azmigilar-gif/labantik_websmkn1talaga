                    ...
                    <div class="card-body">
                            ...
                            <table id="rowBorder" class="w-full">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-left p-2">Profile Sekolah</th>
                                        ...
                                        <div id="editProfileModal{{ $p->id }}" modal-center=""
                                            ...
                                            <div class="w-screen md:w-[30rem] bg-white shadow rounded-md dark:bg-zink-600">
                                                ...
                                                <div
                                                    ...
                                                    <form id="edit-form" action="{{ route('admin.profiles.update', $p->id) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('PUT')
                        ...
                        @else
                            ...
                            <div class="py-12 text-center">
                                ...
                                <h3 class="text-lg font-semibold mb-2">Belum ada Profile Sekolah</h3>
                                <p class="text-sm text-slate-500 mb-4">Belum ada Profile Sekolah yang dibuat. Klik tombol
                                    "Tambah
