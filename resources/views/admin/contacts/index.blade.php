                ...
                <div class="card">
                    <div class="card-body">
                        <div class="mb-4 flex items-center justify-between gap-2">
                            <h2 class="text-lg font-semibold text-slate-800 dark:text-zink-100">Daftar Kontak</h2>
                            <a href="{{ route('admin.contacts.create') }}" class="btn bg-custom-500 border-custom-500 text-white hover:text-white hover:bg-custom-600 hover:border-custom-600">
                                Tambah Kontak
                            </a>
                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="p-2">
                                                <div class="flex gap-2">
                                                    ...
                                                    <a href="{{ route('admin.contacts.edit', $c->id) }}"
                                                    ...
                                                    <a href="#!" data-modal-target="deleteModal{{ $c->id }}"
                                                ...
                                                <div class="w-screen md:w-[25rem] bg-white shadow rounded-md dark:bg-zink-600">
                                                    <div class="max-h-[calc(theme('height.screen')_-_180px)] overflow-y-auto px-6 py-8">
                                                        ...
                                                        <div class="mt-5 text-center">
                                                            <h5 class="mb-1 text-lg font-bold">Hapus Kontak?</h5>
                                                            <p class="text-slate-500 dark:text-zink-200 text-sm">Apakah Anda yakin ingin menghapus data kontak ini?</p>
                                                            <div class="flex justify-center gap-2 mt-6">
                                                                <form action="{{ route('admin.contacts.destroy', $c->id) }}" method="POST">
                                                                    @method('DELETE')
                                                                    @csrf
                                                                    <button type="button" data-modal-close="deleteModal{{ $c->id }}"
                        ...
                        @else
                            <div class="py-12 text-center text-slate-500 dark:text-zink-200">
                                <i data-lucide="book-user" class="mx-auto size-12 text-slate-300 dark:text-zink-500 mb-3"></i>
                                <p class="font-medium">Belum ada data kontak yang terdaftar.</p>
                                <a href="{{ route('admin.contacts.create') }}" class="text-custom-500 hover:underline mt-2 inline-block text-sm font-semibold">
                                    Tambah Kontak Baru
                                </a>
                            </div>
                        @endif
