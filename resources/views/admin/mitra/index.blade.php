    ...
    <div
        ...
        <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
            ...
            <div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
                <div class="grow">
                    <h5 class="text-16">Mitra Industri</h5>
                </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="mb-4 flex items-center justify-between gap-2">
                            <h2 class="text-lg font-semibold text-slate-800 dark:text-zink-100">Daftar Mitra Industri</h2>
                            <a href="{{ route('admin.mitra.create') }}" class="btn bg-custom-500 border-custom-500 text-white hover:text-white hover:bg-custom-600 hover:border-custom-600">
                                Tambah Mitra
                            </a>
                        </div>
                        ...
                        @else
                            <div class="py-12 text-center text-slate-500 dark:text-zink-200">
                                <i data-lucide="briefcase" class="mx-auto size-12 text-slate-300 dark:text-zink-500 mb-3"></i>
                                <p class="font-medium">Belum ada data mitra industri yang terdaftar.</p>
                                <a href="{{ route('admin.mitra.create') }}" class="text-custom-500 hover:underline mt-2 inline-block text-sm font-semibold">
                                    Tambah Mitra Baru
                                </a>
                            </div>
                        @endif
