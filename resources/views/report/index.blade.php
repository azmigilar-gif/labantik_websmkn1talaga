        ...
        <div class="card">
            <div class="card-body">
                ...
                <div id="tagNewsChart"
                     ...
                     data-chart-colors='["bg-blue-500", "bg-orange-500", "bg-teal-500", "bg-yellow-500", "bg-purple-500", "bg-pink-500", "bg-indigo-500", "bg-red-500", "bg-green-500", "bg-cyan-500", "bg-amber-500", "bg-lime-500", "bg-emerald-500", "bg-violet-500", "bg-fuchsia-500", "bg-rose-500", "bg-sky-500", "bg-slate-500"]'
                     dir="ltr">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    fetch(url)
        ...
        .catch(error => {
            ...
            document.getElementById('tagNewsChart').innerHTML =
                '<div class="text-center py-8 text-red-500">Gagal memuat data chart: ' + error.message + '</div>';
        });
});
</script>
@endpush
